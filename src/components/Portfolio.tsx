    ...
    <section id="portfolio" className="py-20 bg-white">
      <div className="container mx-auto px-4">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Category Badge */}
                <div
                  className={`absolute top-4 left-4 bg-gradient-to-r ${project.color} text-white px-3 py-1 rounded-full text-sm font-medium`}
                >
                  {project.category}
                </div>
              </div>
        ...
        >
          ...
          <button className="bg-primary-600 text-white px-8 py-4 rounded-xl hover:bg-primary-700 transition-colors font-semibold text-lg shadow-lg hover:shadow-xl">
            Iniciar Meu Projeto
          </button>
        </motion.div>
      </div>
